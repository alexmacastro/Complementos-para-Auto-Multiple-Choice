# -*- coding: utf-8 -*-
"""
Enviar enunciados (hojas que deben leer para responder en las plantillas)
...
def mensaje_html(apellidos,nombre,codigoID): 
    ...
    <p><span style="font-size: small;">Le escribo este mensaje para enviarle su hoja de enunciados </span></p>
    <P><span style="font-size: small;">Utilice para responder la hoja de respuestas que le envi&eacute; en su momento, y que debe tener impresa, para responder. </span></p>
    ...
    <p><span style="font-size: small;">Este documento sirve para conocer las preguntas de su examen.</span></p>
    <p><span style="font-size: small;">Su examen ha sido personalizado. No imprima ni escriba en esta hoja. No la entregue.</span></p>
...
def mensaje_texto(apellidos,nombre,codigoID):
    ...
    Le escribo este mensaje para enviarle su hoja de enunciados.
    
    Utilice para responder la hoja de respuestas que le envié en su momento, y que debe tener impresa para responder. 
    ...
    Este documento sirve para conocer las preguntas de su examen.
    
    Su examen ha sido personalizado. No imprima ni escriba en esta hoja. No la entregue. 
...
pm_asunto = 'HOJA DE ENUNCIADO (NO ESCRIBIR EN ELLA, NI IMPRIMIR, NI ENTREGAR)'
...
for index,row in enumerate(reader):
    if index > 0:
        ...
        numfile = str(index)
        fichero = 'sheet-'+ numfile.zfill(4) + '-0S.pdf'
